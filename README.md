...
*2.Change the parameter of the  setwd function call (row 20) to the working directory/UCI HAR Dataset (i.e., the folder where these the R script file is saved).
